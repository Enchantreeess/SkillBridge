...
('Philosophy for Beginners', 'Introduction to philosophical thinking', 'Anusha Singh', 'Humanities', '/placeholder.svg?height=200&width=300&text=Philosophy', 45, 'Beginner', false),
('Art History Overview', 'Journey through major art movements', 'Anusha Singh', 'Humanities', '/placeholder.svg?height=200&width=300&text=Art', 50, 'Beginner', false)
