...
const team = [
  {
    ...
    image: "/placeholder.svg?height=400&width=400&text=Aadiraj+Singh+Chauhan",
    quote: "Learning should be accessible, engaging, and transformative for everyone.",
    specialty: "Full-Stack Development & AI",
    github: "https://github.com/aadiraj",
    linkedin: "https://linkedin.com/in/aadiraj",
    twitter: "https://twitter.com/aadiraj",
              ...
              <div className="bg-white/60 backdrop-blur-sm border border-sage-200/50 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-[1.02]">
                ...
                <div className="flex justify-center space-x-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-sky-500 hover:bg-sky-600 text-white rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:rotate-12 hover:shadow-lg"
                  >
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
